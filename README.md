Program za pomocą web obsługuję stronę klienta firmy pacztex, aby uruchomić program należy wejść do katalogu web i wykonać komendę python3 app.py lub poprzez link heroku
